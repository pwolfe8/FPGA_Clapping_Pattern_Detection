...
HD_PWD='/home/will/DSP/FPGA_Clapping_Pattern_Detection/VHDL_TESTS/min_not_zero/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log min_not_zero.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source min_not_zero.tcl -notrace
