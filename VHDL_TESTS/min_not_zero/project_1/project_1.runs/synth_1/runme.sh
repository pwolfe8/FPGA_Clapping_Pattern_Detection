...
HD_PWD='/home/will/DSP/FPGA_Clapping_Pattern_Detection/VHDL_TESTS/min_not_zero/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log min_not_zero.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source min_not_zero.tcl
