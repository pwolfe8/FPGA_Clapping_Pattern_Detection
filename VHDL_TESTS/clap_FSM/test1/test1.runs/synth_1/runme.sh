...
HD_PWD='/home/will/DSP/FPGA_Clapping_Pattern_Detection/VHDL_TESTS/clap_FSM/test1/test1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clap_FSM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clap_FSM.tcl
