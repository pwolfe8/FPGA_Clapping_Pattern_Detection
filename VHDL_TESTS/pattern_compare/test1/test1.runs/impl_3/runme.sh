...
HD_PWD='/home/will/DSP/FPGA_Clapping_Pattern_Detection/VHDL_TESTS/pattern_compare/test1/test1.runs/impl_3'
cd "$HD_PWD"
...
EAStep vivado -log pattern_compare.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pattern_compare.tcl -notrace
