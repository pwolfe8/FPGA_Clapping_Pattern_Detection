...
HD_PWD='/home/will/DSP/FPGA_Clapping_Pattern_Detection/VHDL_TESTS/pattern_compare/test1/test1.runs/synth_4'
cd "$HD_PWD"
...
EAStep vivado -log pattern_compare.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pattern_compare.tcl
