...
HD_PWD='/home/will/DSP/FPGA_Clapping_Pattern_Detection/VHDL_TESTS/divide_by_min/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log div_by_min.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source div_by_min.tcl
